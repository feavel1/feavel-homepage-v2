<script>
	...
	import img1 from '../../public/img/waixin-001.png';
	import img2 from '../../public/img/waixin-002.png';
	import img3 from '../../public/img/waixin-003.png';
</script>
	...
	<div class="max-w-4xl mx-auto grid grid-cols-1 lg:max-w-5xl lg:gap-x-20 lg:grid-cols-2">
		...
		>
			...
			<dd class="flex items-center">
				...
				<div class="flex my-3">
					<h1 class="typewriter dark:after:bg-slate-700 after:bg-zinc-200">
						<a class="text-teal-300 hover:underline" href="https://kit.svelte.dev">Chakara UI</a> +
						<a class="text-purple-400 hover:underline" href="https://tailwindcss.com"
							>Framer Motion</a
						> = Ali3n-babies
					</h1>
				</div>
